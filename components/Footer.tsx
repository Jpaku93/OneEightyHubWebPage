...
import { ArrowRight, Instagram, Youtube, Twitter, Music, Lock } from 'lucide-react';
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        <div className="tech-reveal delay-100">
          ...
          <ul className="space-y-4 text-gray-400 text-sm mb-6">
            <li className="hover:text-brand-lime cursor-pointer transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-brand-orange rounded-full opacity-0 hover:opacity-100 transition-opacity"></span> Instagram</li>
            <li className="hover:text-brand-lime cursor-pointer transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-brand-orange rounded-full opacity-0 hover:opacity-100 transition-opacity"></span> YouTube</li>
            <li className="hover:text-brand-lime cursor-pointer transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-brand-orange rounded-full opacity-0 hover:opacity-100 transition-opacity"></span> TikTok</li>
            <li className="hover:text-brand-lime cursor-pointer transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-brand-orange rounded-full opacity-0 hover:opacity-100 transition-opacity"></span> Spotify Playlist</li>
          </ul>
          <div className="flex gap-4 text-gray-400">
            <div className="p-2 bg-white/5 rounded-full hover:bg-brand-purple hover:text-white transition-colors cursor-pointer">
